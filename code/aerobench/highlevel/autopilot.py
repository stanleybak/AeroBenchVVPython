...
class GcasAutopilot(Autopilot):
    ...
    def __init__(self, xequil, uequil, flightLimits):
        Autopilot.__init__(self, xequil, uequil, flightLimits)
    ...
    def get_u_ref(self, t, x_f16):
        ...
        Nz_des = min(5, self.llc.ctrlLimits.NzMax) # Desired maneuver g's
...
class FixedSpeedAutopilot(Autopilot):
    ...
    def __init__(self, setpoint, p_gain, xequil, uequil, flightLimits):
